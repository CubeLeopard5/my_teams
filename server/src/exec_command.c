...
{
    void (*builtins_functions[])(server_t *server, size_t client_nbr, char **command) = {
        &help, &login, &send_pvt, &logout, &quit, &display_users, &display_user,
        &display_conv, NULL
    }; //Function pointers void function() server_t *server, size_t client_nbr, char **command
